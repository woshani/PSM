...
public class NotificationController {
	...
	public static int pushFCMNotification(String userDeviceIdKey,
		...
		try {
			...
			// pass FCM server key
			conn.setRequestProperty("Authorization", "key=AAAAohCpuoo:APA91bG3rgqdkn8XdgWT_P7Sp-g8kBt0CMjDGu58VcRrfU5-3_mEyFbI3onCEVjrMNGGYmXD7DPITPqwKZHeHJgshnYAWXCdZL3SOShUqqrJ5RBRjvpgbhWyVHOjYJY6L4mvm-kCvVM9");
