				...
				<div class="card-content table-responsive">
					<form id="formoverview">
						<div class="row">
							<div class="col-md-2">
								<div class="form-group label-floating">
									<label class="control-label">Sessions</label> <select
							...
							<div class="col-md-2">
								<div class="form-group label-floating" id="divcourse">
									<label class="control-label">Course</label> <select
										class="form-control" id="selcourselist">
							...
							<div class="col-md-2 hidden" >
								<div class="form-group label-floating" id="divyear">
									<label class="control-label">Year</label><select
										class="form-control" id="selyearlist">
						...
						<button type="button" class="btn btn-primary pull-right"
							id="btnSearchOverview">Search</button>
...
<div class="row">
	<div class="col-md-7">
		<div class="card" hidden id='divForGraphOverview'>
			<div class="card-header card-chart" data-background-color="green">
				<div class="ct-chart" id="overviewChart"></div>
			</div>
			<div class="card-content">
				<h4 class="title" id="titleOverview">...</h4>
				<p class="category" id="subtitleOverview">..</p>
			</div>
		</div>
	</div>
</div>
