...
/**
 * Servlet implementation class TransferStudentProcess
 */
@WebServlet("/TransferStudentProcess")
public class TransferStudentProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TransferStudentProcess() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			for(int index=0; index<studentIdEnc.length; index++) {
				...
				result = controller.studentTransferProcess(studentId, date , classId);
				//System.out.println(studentId+" "+date+" "+classId);
