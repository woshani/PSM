...
/**
 * Servlet implementation class PDFHem
 */
@WebServlet("/PDFHem")
public class PDFHem extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String fileName = "Kedatangan_Bulan_" + formatedMonthTitle + ".pdf";
			// declare an object from java file
			PDFHemAttendance pdf = new PDFHemAttendance();
			...
			pdf.addWholePage(document, teacher.getTeacher_id(), newMonth, newYear);
			document.close();
