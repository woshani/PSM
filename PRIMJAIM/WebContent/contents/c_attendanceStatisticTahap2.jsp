...
<%
	...
	String dateForPrint = ft2.format(dNow);

	attendanceStatistics = controller.getAttendanceStatisticsByTahap(
			instituition.getAcademic_instituition_id(), todayDate, 2);
	AttendanceStatistics totalAttendanceStatistic = controller
			.getTotalAttendanceStatisticsByTahap(
...
<table width="1000px" border="0" cellspacing="0" cellpadding="3">
	<tr>
		<td align ="center"><b><h3>Statistik Kedatangan Tahap 2</h3></b></td>
	</tr>
</table>
