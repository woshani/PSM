	...
	<div>
		<table width="1000px" border="0" cellpadding="5">
				...
				<%
					...
					for(Dun dunv1 : duns){
						ppdAttendance = controller.politicianReport(dunv1.getId());
						count = count + 1;	
						%>
						<tr>	
							<td align=center><%=count %></td>
							<td><a href="politicianReportDetail.jsp?dunId=<%=dunv1.getId()%>"><%=dunv1.getName() %></a></td>
