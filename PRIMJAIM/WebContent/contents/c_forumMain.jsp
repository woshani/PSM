...
<br />
<p>
	<font color="red"> * </font><font color="black">Sila <a href="logIn.jsp"><strong>LOG
			MASUK</strong></a> untuk membuat aduan.
	</font>
</p>
<%
	if (topics.isEmpty()) {
...
<div class="topicMain">
	<div class="topicMainLeft">
		...
		<p><%=topic.getText()%></p>
		<p>Daripada : <strong><%=topic.getTeacherName()%></strong></p>
	</div>
	<div class="topicMainRight">
		<img src="${pageContext.request.contextPath}/images/message.png"
			height="30" width="30">
		<strong><%=topic.getTotalDiscussion()%></strong>
		&nbsp
