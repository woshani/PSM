...
<body>
	...
	<div id="page" class="container">
		<div id="box1" align=center>
			<h2 class="title">Rekod Laporan Kehadiran Harian</h2>
			<div class="entry">
				<%
				...
				<form name="SearchForm" method="post" action="PoliticianReportHistory">
				...
				<jsp:include page="contents/c_politicianReportHistory.jsp"></jsp:include>
				<%
					}
				%>
			</div>
