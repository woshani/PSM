...
<div id="page" class="container">
	<div id="box1">
		<div style="clear: both;"><center><h2 class="title">REKOD STATISTIK LAPORAN KEHADIRAN HARIAN </br> <b><%=station.getName()%></b> </br></h2></center>
		</div>
		<div style="clear: both;">&nbsp;</div>

		<jsp:include page="contents/c_policeReportDetail.jsp"></jsp:include>
